export default (data) => {
  return {
    ...
    primaryColor: data.primaryColor ? data.primaryColor : "#252b86",
    ...
    favicon: data.favicon ? data.favicon : require("../../static/logo.png"),
    lat: data.lat ? data.lat : "-33.410167",
    lng: data.lng ? data.lng : "-70.655265",
    logo: data.logo ? data.logo : require("../../static/logo.png"),
    logoDark: data.logoDark ? data.logoDark : require("../../static/logo.png"),
    ...
    home: {
      hero: {
        background:
          data.home && data.home.hero && data.home.hero.background
            ? data.home.hero.background
            : require("../../static/hero5.jpg"),
        title:
          data.home && data.home.hero && data.home.hero.title
            ? data.home.hero.title
            : "Tenemos las mejores propiedades vacacionales para ti y tu familia.",
      },
      properties: {
        title:
          data.home && data.home.properties && data.home.properties.title
            ? data.home.properties.title
            : "Contamos con una selección exclusiva de propiedades.",
        maxProperties:
          data.home &&
          data.home.properties &&
          data.home.properties.maxProperties
            ? data.home.properties.maxProperties
            : 9,
        footer:
          data.home && data.home.properties && data.home.properties.footer
            ? data.home.properties.footer
            : "Estas son solo algunas de las propiedades que tenemos para ofrecerte",
        buttonText:
          data.home && data.home.properties && data.home.properties.buttonText
        ...
        banner: {
          ...
          subTitle:
            ...
            data.home.about.banner.subTitle
              ? data.home.about.banner.subTitle
              : "Esto nos permite entender mejor que nadie las necesidades de nuestros clientes, por eso ponemos el foco en que la experienca de compra o arriendo sea única",
          buttonText:
            data.home &&
            data.home.about &&
            data.home.about.banner &&
      ...
      services: {
        items:
          data.home && data.home.services && data.home.services.items.length
      ...
      reviews: {
        items:
          data.home && data.home.reviews && data.home.reviews.items.length
            ? data.home.reviews.items
            : [
                {
                  id: null,
                  review:
    ...
    about: {
      hero: {
        background:
          data.about && data.about.hero && data.about.hero.background
            ? data.about.hero.background
            : require("../../static/hero5.jpg"),
        title:
          data.about && data.about.hero && data.about.hero.title
            ? data.about.hero.title
            : "Un equipo de profesionales especializados en el sector inmobiliario.",
      },
      history: {
        background:
          data.about && data.about.history && data.about.history.background
            ? data.about.history.background
            : require("../../static/hero4.jpg"),
        description:
          data.about && data.about.history && data.about.history.description
        ...
        title:
          data.about && data.about.history && data.about.history.title
      ...
      description: {
        items:
          ...
          data.about.description.items.length
      ...
      stats: {
        proffesionals:
          data.about && data.about.stats && data.about.stats.proffesionals
            ? data.about.stats.proffesionals
            : 70,
        properties:
          data.about && data.about.stats && data.about.stats.properties
            ? data.about.stats.properties
            : 1000,
        years:
          data.about && data.about.stats && data.about.stats.years
            ? data.about.stats.years
            : 50,
        transactions:
          data.about && data.about.stats && data.about.stats.transactions
      ...
      team: {
        visible: true,
        items:
          data.about && data.about.team && data.about.team.items.length
      ...
      ubication: {
        title:
          data.about && data.about.ubication && data.about.ubication.title
    ...
    contact: {
      ...
      subTitle:
        data.contact && data.contact.subTitle ? data.contact.subTitle : "234",
    },
  };
};
